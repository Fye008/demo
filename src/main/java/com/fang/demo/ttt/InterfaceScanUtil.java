...
public class InterfaceScanUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(InterfaceScanUtil.class);
    ...
    public static String getPkgPath(String pkgName){
        ...
        return url == null ? null : url.getFile() + pkgDirName;
    }
    ...
    public static void main(String[] args) {
        String pkgName = "com.fang.demo.controller";
        String pkgPath = getPkgPath(pkgName);
        logger.info("pkgPath is {}", pkgName);
        String pkgPath2 = "G:/ideaworkspace/demo/target/classes/com/fang/demo/controller";
        ...
        Map<Class<? extends Annotation>, Set<Method>> methodMap = scanMethodsByAnnotations(classSet, Arrays.asList(GetMapping.class, PostMapping.class, DeleteMapping.class, PutMapping.class));
        if (methodMap.size() == 0){
